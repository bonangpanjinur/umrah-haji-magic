          ...
          <TabsContent value="config">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Atur provider dan API key untuk integrasi WhatsApp
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSaveConfig} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Dapatkan API key dari dashboard provider Anda
                    </p>
                  </div>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between">
                ...
                <Dialog open={isTemplateDialogOpen} onOpenChange={setIsTemplateDialogOpen}>
                  <Button onClick={() => { setEditTemplate(null); setIsTemplateDialogOpen(true); }}>
                    ...
                    <form onSubmit={handleSaveTemplate} className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            defaultValue={editTemplate?.code || ""}
                            required
                          />
                        </div>
                        <div className="space-y-2">
                          ...
                          <Input
                            id="name"
                            name="name"
                            placeholder="Konfirmasi Booking"
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                          ...
                          placeholder="Assalamu'alaikum {nama}, booking Anda..."
                          rows={5}
                          defaultValue={editTemplate?.message_template || ""}
                          required
                        />
                      </div>
                      <div className="space-y-2">
                        ...
                        <Input
                          id="variables"
                          name="variables"
                          placeholder="nama, kode_booking, total_harga"
                          defaultValue={editTemplate?.variables?.join(", ") || ""}
                        />
                      </div>
                      <DialogFooter>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Button
                  ...
                  disabled={!testPhone || !testTemplate || sendTestMutation.isPending}
                >
