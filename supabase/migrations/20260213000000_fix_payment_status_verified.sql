...
ALTER TYPE public.payment_status ADD VALUE IF NOT EXISTS 'verified' AFTER 'paid';

-- Update award_loyalty_points_on_payment function to handle both 'paid' and 'verified'
-- This ensures compatibility if 'paid' is used as the final status
